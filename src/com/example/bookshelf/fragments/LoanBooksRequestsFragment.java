 ...
 */
public class LoanBooksRequestsFragment extends Fragment {
    ListView list;
    BookAdapter adapter;
    ProgressBar pb;
    ...
    private void updateDisplay() {
        if (borrowedBooks != null) {
            adapter = new BookAdapter(getActivity(), R.layout.item_request, borrowedBooks, this);
            list.setAdapter(adapter);
        }
    }

    /**
     * Make request requests call to restful
     *
     * @param uri
    ...
    private void requestRequests(String uri) throws JSONException {
        ...
        object.put("method", "getloanbookrequest"); // What kind of request
    ...
    public void requestReplyRequests(int position, boolean b) throws JSONException {
        ...
        object.put("id", SaveSharedPreference.getID(getActivity())); // Pass the id for the user to the webservice
        object.put("friendid", borrowedBook.getRenter().getId());
